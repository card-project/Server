		...
		try {
			...
			while((this._instruction = this._input.readLine()) != null)
			{
				if(this._instruction.equalsIgnoreCase("quit")) {
					...
					System.out.println("=====================");
					Logger.getInstance().addEntry("Server closed.");
					System.exit(0);
				}
					...
					int nbSlots = Server.getDefaultSlots();
					do
					{
						System.out.print("> ");
						try
				...
				else if(this._instruction.equalsIgnoreCase("waiting")) {
					
					System.out.println("There is " + this._serv.getWaitingPlayers().size() + " players waiting.");
					
				}
				else if(this._instruction.equalsIgnoreCase("help")) {
					System.out.println("=====================");
					System.out.println("Free : Count of free places on the server.");
					System.out.println("New : Create a new server.");
					System.out.println("Waiting : Show the list of waiting players.");
